...
reload.CIMICE = function(){
  tryCatch(devtools::uninstall("CIMICE"),
    finally={devtools::install_github("redsnic/CIMICE-R", subdir="CIMICE")})
}
# CIMICE lib
#reload.CIMICE()
if(!require(CIMICE)){
  devtools::install_local("~/git/CIMICE-R/CIMICE")
  library(CIMICE)
}
